...
> “That actually kind of reminds me that there's another challenge is that there's a lot of history that this that I was not… would anyone just, like, tell a new contributor the entire history of the project? To understand the history of why certain things are the way they are, why certain attitudes are the way they are for certain people, and who has been pushed away historically… I think from the DEI perspective, I'm really challenged by figuring out how to approach that. How do I approach the history of all of it? How do I approach making it better in general?” (name redacted until approval received) 
